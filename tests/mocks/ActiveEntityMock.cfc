component name="ActiveEntityMock" extends="cbmongodb.models.ActiveEntity" accessors=true{
	...
	property name="address.street" schema=true parent="address" validate="string";
	property name="address.city" schema=true parent="address" validate="string";
	property name="address.state" schema=true parent="address" validate="string" length=2;
	property name="address.postalcode" schema=true parent="address" validate="zipcode";
	property name="country" schema=true parent="address" validate="string";
	property name="phone" schema=true validate="struct";
	property name="phone.home" schema=true parent="phone" validate="telephone";
	property name="phone.work" schema=true parent="phone" validate="telephone";
	property name="phone.mobile" schema=true parent="phone" validate="telephone";
